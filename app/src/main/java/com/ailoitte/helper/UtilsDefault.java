...
public class UtilsDefault {
    ...
    public static String getRealPathFromURI(Context context, Uri contentUri) {
        ...
        try {
            ...
            Log.e("pathfile", "getRealPathFromURI Exception : " + e.toString());
            return "";
        } finally {
            if (cursor != null) {
                cursor.close();
...
//            if (outPut.contains("24")){
//                outPut=outPut.replace("24","00");
//
//            }
            try {
                String[]data=outPut.split(":");
                if (data[0].contains("24")){
                    outPut="00:"+data[1];
                }
            }
            catch (Exception e){
    ...
    public static String dateFormatWithoutYear(String dateString){
    ...
    public static boolean isOnline() {
       ...
       // Log.d("networkinfo", "isOnline: "+netInfo.getExtraInfo());
